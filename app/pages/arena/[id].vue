<template>
	<div class="arena-page">
		...
		<main class="arena-content">
			...
			<div v-else-if="finished" class="finished-screen">
				<div class="finished-box">
					<span class="finished-icon">🎉</span>
					<h1>TAREFA CONCLUIDA!</h1>
					<p>Parabens! Voce completou todas as etapas com sucesso.</p>
					<p class="finished-sub">Suas respostas foram enviadas ao professor.</p>
					<button class="btn-home" @click="goHome">VOLTAR PARA O INICIO</button>
				</div>
			</div>
...
<style scoped=''>
	...
	.finished-screen { display: flex; align-items: center; justify-content: center; min-height: 60vh; }
	.finished-box { text-align: center; padding: 60px 40px; background: rgba(63,224,168,0.06); border: 1px solid rgba(63,224,168,0.2); border-radius: 24px; max-width: 500px; }
	.finished-icon { font-size: 64px; display: block; margin-bottom: 20px; }
	.finished-box h1 { font-family: var(--font-display); font-size: 32px; color: #3fe0a8; margin: 0 0 12px; }
	.finished-box p { color: var(--ink-1); font-size: 16px; margin: 0 0 8px; line-height: 1.6; }
	.finished-sub { color: var(--ink-3); font-size: 14px; margin-bottom: 28px; }
	.btn-home { padding: 14px 32px; background: linear-gradient(180deg, rgba(63,224,168,0.2), rgba(63,224,168,0.08)); border: 1px solid #3fe0a8; border-radius: 12px; color: #3fe0a8; font-family: var(--font-display); font-size: 13px; font-weight: 700; letter-spacing: 2px; cursor: pointer; transition: all 0.2s; }
	.btn-home:hover { background: linear-gradient(180deg, rgba(63,224,168,0.3), rgba(63,224,168,0.15)); box-shadow: 0 0 24px rgba(63,224,168,0.2); }
